...
<div class="wrap">
    ...
    <div class="hexagone2">
        <div class="hexagonemain">
            <div class="hexagonemainbefore">
                <a href="#ex2" rel="modal:open"> <img class="portrait" src="assets/img/personnes.jpg" alt="">
                </a>
            </div>
        </div>
    </div>
    <div class="hexagone2">
        <div class="hexagonemain">
            <div class="hexagonemainbefore">
                <a href="#ex3" rel="modal:open"> <img class="portrait" src="assets/img/personnes.jpg" alt="">
                </a>
            </div>
        </div>
    </div>
    <div id="hexatop" class="hexagone">
        <div class="hexagonemain">
            <div class="hexagonemainbefore">
                <a href="#ex4" rel="modal:open"> <img class="portrait" src="assets/img/IMG_1047.jpeg" alt="">
                </a>
            </div>
        </div>
    </div>
